...
const CHECKLIST = [
  "Budget clair, sans jargon financier",
  "Bénévoles bien dimensionnés",
      ...
      <div className="mx-auto max-w-[1280px] px-[6%]">
        <div className="grid items-center gap-12 md:grid-cols-[1.1fr_1fr]">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-[color:var(--color-primary)] shadow-sm">
              <Sparkles className="h-4 w-4" /> MVP gratuit pour les associations
            </div>
            <h1 className="font-heading text-[2.4rem] font-bold leading-[1.15] tracking-[0.5px] text-[color:var(--color-text-title)] md:text-[3rem] md:leading-[1.1]">
              ...
              {" "}
              <span className="highlight">simplement</span> et sans stress.
            </h1>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Link href="/planner">
                <Button size="lg">Créer mon plan gratuitement</Button>
              </Link>
            ...
            <div className="rounded-2xl border border-[color:var(--color-border)] bg-white p-6 shadow-[0_10px_50px_0_rgba(49,107,242,0.2)]">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-heading text-xl font-semibold text-[color:var(--color-text-title)]">Kermesse de l&apos;école Jean Moulin</p>
                </div>
                <span className="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">Bien parti</span>
              </div>
              <div className="mt-6 grid grid-cols-3 gap-3">
                <div className="rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-bg-strip)] p-3">
                  <p className="text-xs text-[color:var(--color-text-muted)]">Argent restant</p>
